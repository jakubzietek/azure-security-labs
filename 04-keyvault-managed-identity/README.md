...
!\[Web App Managed Identity Enabled](./01-webapp-identity-on.png)
...
!\[Key Vault Role Assignment](./02-keyvault-webapp-roleassign.png)
...
!\[Key Vault Reference in App Settings](./03-keyvault-reference.png)
...
!\[Key Vault Reference Successfully Resolved](./04-keyvault-reference-validated.png)
...
!\[Access Failure After Role Removal](./05-webapp-after-removal.png)
...
!\[Log Analytics Workspace Created](./06-loganalytics-workspace-created.png)
...
!\[Key Vault Diagnostic Settings to Log Analytics](./07-diagnosticsetting-auditlogs-to-LAW.png)
